...
<body class="antialiased">
    <div
        ...
        <div>
            <p style = 'font-size: 40px;' class="mb-4 text-6xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl ">Bienvenido a la Biblioteca</p>

            <p class="mb-4 text-6xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">Inicia sesión para continuar</p>
        </div>
    </div>
</body>

</html>
<?php /**PATH C:\laragon\www\libros\resources\views/welcome.blade.php ENDPATH**/ ?>